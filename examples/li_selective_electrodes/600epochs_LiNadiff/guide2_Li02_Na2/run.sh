...
mattergen-generate . --model_path=/home/ilgar/MatterGen_extractLi/outputs/singlerun/2025-12-08/19-42-57  --batch_size=100 --properties_to_condition_on="{'Li_voltage': 0.2, 'Na_voltage': 2.0}" --diffusion_guidance_factor=2.0 --num_batches=1
