...
mattergen-generate . --model_path=/home/ilgar/MatterGen_extractLi/outputs/singlerun/2025-12-17/15-43-23  --batch_size=256 --properties_to_condition_on="{'Li_voltage': 0.2, 'Na_voltage': 2.0}" --diffusion_guidance_factor=4.0 --num_batches=8
